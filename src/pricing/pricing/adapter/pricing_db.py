...
pricing_priced_items_table = sa.Table(
    ...
    metadata,
    sa.Column('product_id', sa.String(40), nullable=False, primary_key=True),
...
@event.listens_for(PricedItem, 'load')
def priced_item_load(priced_item, _):
    priced_item.domain_events = []
