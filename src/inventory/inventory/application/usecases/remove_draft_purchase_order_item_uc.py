        ...
        with self._uow as uow:
            try:
                ...
                try:
                    ...
                    raise ThingGoneInBackHoleError(ExceptionMessages.DRAFT_PURCHASE_ORDER_NOT_FOUND)
                ...
                try:
                    ...
                    raise ThingGoneInBackHoleError(ExceptionMessages.DRAFT_PURCHASE_ORDER_ITEM_NOT_FOUND)
