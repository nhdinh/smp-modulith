...
def test_loads_auction_using_id(
        withdrawing_bids_uc: WithdrawingBids, auction: Auction, input_dto: WithdrawingBidsInputDto,
...
def test_saves_auction_afterwards(
        withdrawing_bids_uc: WithdrawingBids, auctions_repo_mock: Mock, auction: Auction,
