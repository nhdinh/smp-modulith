        ...
        with self._uow as uow:  # type:ShopUnitOfWork
            try:
                ...
                update_data = {
                    ...
                    'restock_threshold': dto.restock_threshold if dto.restock_threshold else None,
                    'maxstock_threshold': dto.maxstock_threshold if dto.maxstock_threshold else None,
