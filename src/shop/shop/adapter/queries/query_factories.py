...
from sqlalchemy import select, func, distinct, and_, join
...
from shop.adapter.shop_db import (
    ...
    shop_supplier_table, shop_product_unit_table, shop_product_purchase_price_table, shop_table, shop_users_table,
)
...
from shop.domain.entities.value_objects import ShopId, ShopProductId, GenericShopItemStatus, ShopCatalogId, \
    ShopSupplierId, SystemUserId, ShopStatus
