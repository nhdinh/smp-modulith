...
from identity.identity_handler_facade import (
    CreateUserUponShopRegistrationConfirmedHandler,
...
class IdentityEventHandlerModule(injector.Module):
    ...
    def configure(self, binder: injector.Binder) -> None:
        ...
        binder.multibind(Handler[ShopRegistrationConfirmedEvent],
                         EventHandlerProvider(CreateUserUponShopRegistrationConfirmedHandler))
